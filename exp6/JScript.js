...
var d = stu_obj[i].dob;
str1="After 2000";
document.getElementById('after').innerHTML = str1;
if ( parseInt(d.slice(7,11))> 2000){
str = str + "<br>" + "Name: " + n + "<br>" + "Register Number: " + r +
"<br>" + "Date Of Birth: " + d + "<br>";
document.getElementById('stu1').innerHTML = str;
str2="Before 2000"
document.getElementById('before').innerHTML = str2;
}
else{
var llr = "<br>" + "Name: " + n + "<br>" + "Register Number: " + r +
"<br>" + "Date Of Birth: " + d + "<br>";

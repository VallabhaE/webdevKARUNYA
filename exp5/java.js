function string() {
    ...
    document.getElementById("outputmin").innerHTML = "Shortest word: " +
    minstr.toString();
    document.getElementById("outputmax").innerHTML = "Longest word: " +
    maxstr.toString();
    }
    function bmi(){
        ...
        var bmi = w /(h * h);
        var result;
        if (bmi <18 && bmi <25) result ="Normal";
    ...
    function grow() {
        ...
        var l = ["images/Strawberry.jpg", "images/StarFruit.jpg"];
        var garden = document.getElementById("garden");
        for (let i = 0; i < r; i++) {
        for (let j = 0; j < c; j++) {
        var fruit = Math.floor(Math.random() * 2);
        var img = '<img src=' + l[fruit] + ' width = "150px" height =
        ...
        function convert() {
            ...
            ans.innerHTML = amt.toString() + " " + from + " = " + result.toString() +
            " " + to;
            }
            function flip() {
                ...
                function bill() {
                    ...
                    total += tip;
                    document.getElementById("price").innerHTML = "Cost of order: " + total + "
                    rupees!"
                    }